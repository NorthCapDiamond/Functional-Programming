...
(let ((t (append-rbmset
          ...
          (append-rbmset
           ...
           (append-rbmset
            ...
            (append-rbmset
             5
             (append-rbmset 7 (append-rbmset 10 (create-rbmset 6)))))))))
  (display-and-test
   (rbmset->string (filter-rbmset t bigger-zero?))
   " 2  3  5  6  7  10 \n"
   "Test > 0")
  (display-and-test
   (rbmset->string (filter-rbmset t below-three?))
   " 0  2 \n"
   "Test < 3")
  (display-and-test
   (rbmset->string (filter-rbmset t odd?))
   " 3  5  7 \n"
   "Test Odd")
  (display-and-test
   (rbmset->string (filter-rbmset t even?))
   " 0  2  6  10 \n"
   "Test Even")
  (display-and-test
   (rbmset->string (filter-rbmset (append-rbmset 2 t) even?))
   " 0  2  2  6  10 \n"
          ...
          (append-rbmset
           ...
           (append-rbmset
            ...
            (append-rbmset
             ...
             (append-rbmset 7 (append-rbmset 10 (create-rbmset 6)))))))))
  (display-and-test
   (rbmset->string (map-rbmset t x2))
   " 0  4  6  10  12  14  20 \n"
   "Test X*2")
  (display-and-test
   (rbmset->string (map-rbmset t pow2))
   " 0  4  9  25  36  49  100 \n"
   "Test X^2")
  (display-and-test
   (rbmset->string (map-rbmset (append-rbmset 3 t) pow2))
   " 0  4  9  9  25  36  49  100 \n"
...
(let ((t (append-rbmset
  ...
  (display-and-test
   (left-fold-rbmset * 1 t)
   0
   "Check fold on mul (reaction on zero element)")
  (display-and-test
   (left-fold-rbmset * 1 (remove-rbmset 0 t))
   12600
   "Check fold on mul")
...
(let ((t (append-rbmset
  ...
  (display-and-test
   (right-fold-rbmset * 1 t)
   0
   "Check fold on mul (reaction on zero element)")
  (display-and-test
   (right-fold-rbmset * 1 (remove-rbmset 0 t))
   12600
   "Check fold on mul")
  (display-and-test
...
(let ((t1 #f)
  ...
  (display-and-test
   (compare t4 t4)
   #t
   "Compare two the same (with duplicates)")
  (display-and-test
...
(let ((no-children (node-constructor 'black #f 0 #f 1))
      ...
      (right-child
       (node-constructor 'black #f 2 (node-constructor 'red #f 3 #f 1) 1))
      (both-children
       (node-constructor
        'red
        (node-constructor 'black #f 4 #f 1)
        2
        (node-constructor 'red #f 0 #f 1)
        1)))
  (display-and-test
   (node->color no-children)
   'black
   "Check color for no-children case")
  (display-and-test
   (node->value no-children)
   0
   "Check value for no-children case")
  (display-and-test
   (node->left no-children)
   #f
   "Check left child for no-node case")
  (display-and-test
   (node->right no-children)
   #f
   "Check right child for no-node case")
  (display-and-test
   (node->color left-child)
   'red
   "Check color for left-child case")
  (display-and-test
   (node->value left-child)
   2
   "Check value for left-child case")
  (display-and-test
   (node->value (node->left left-child))
   1
   "Check left child value for left-child case")
  (display-and-test
   (node->color (node->left left-child))
   'black
   "Check left child color for left-child case")
  (display-and-test
   (node->right left-child)
   #f
   "Check right child for left-child case")
  (display-and-test
   (node->color right-child)
   'black
   "Check color for right-child case")
  (display-and-test
   (node->value right-child)
   2
   "Check value for right-child case")
  (display-and-test
   (node->value (node->right right-child))
   3
   "Check right child value for right-child case")
  (display-and-test
   (node->color (node->right right-child))
   'red
   "Check right child for right-child case")
  (display-and-test
   (node->left right-child)
   #f
   "Check left child for right-child case")
  (display-and-test
   (node->color both-children)
   'red
   "Check color for both-children case")
  (display-and-test
   (node->value both-children)
   2
   "Check value for both-children case")
  (display-and-test
   (node->value (node->left both-children))
   4
   "Check left child value for both-children case")
  (display-and-test
   (node->color (node->left both-children))
   'black
   "Check left child color for both-children case")
  (display-and-test
   (node->value (node->right both-children))
   0
   "Check right child value for both-children case")
  (display-and-test
...
(let ((tree1 (node-constructor 'red #f 1 #f 1))
  ...
  (display-and-test
   (node->color (recolor-black tree1))
   'black
   "Red must be replaced with Black")
  (display-and-test
...
(let ((a (node-constructor 'black #f 1 #f 1))
      ...
      (y 6)
      (z 7))
  (let ((t1 (node-constructor
             'black
             (node-constructor 'red (node-constructor 'red a x b 1) y c 1)
             z
             d
             1))
        (t2 (node-constructor
             'black
             (node-constructor 'red a x (node-constructor 'red b y c 1) 1)
             z
             d
             1))
        (t3 (node-constructor
             ...
             a
             x
             (node-constructor 'red (node-constructor 'red b y c 1) z d 1)
             1))
        (t4 (node-constructor
             'black
             a
             x
             (node-constructor 'red b y (node-constructor 'red c z d 1) 1)
             1))
        (t5 (node-constructor 'black #f 0 #f 1))
        (t6 (node-constructor 'red #f 0 #f 1))
        (ans (node-constructor
              'red
              (node-constructor 'black a x b 1)
              y
              (node-constructor 'black c z d 1)
              1)))
...
(let ((tree (node-constructor 'black #f 7 #f 1)))
  (let ((t0 (insert 10 tree))
    ...
    (display-and-test
     (node->color (node->left t4))
     'black
     "Case4: check left color")
    (display-and-test
     (node->color (node->right t4))
     'black
     "Case4: check right color")
    (display-and-test
     (node->color (node->right (node->right t4)))
     'red
     "Case4: check right-right color")
    ...
    (display-and-test
     (node->value (node->right (node->right t4)))
     11
...
(let ((t1 (node-constructor 'black #f 1 #f 1))
      ...
      (r #f)
      (v 7))
  (let ((ex1 (node-constructor 'black (node-constructor 'red t1 x t2 1) y t3 1))
        (ans1 (node-constructor
               'red
               (node-constructor 'black t1 x t2 1)
               y
               t3
               1))
        (ex2 (node-constructor
              'black
              t1
              y
              (node-constructor 'black t2 z t3 1)
              1))
        (ans2 (balance
               (node-constructor
                'black
                t1
                y
                (node-constructor 'red t2 z t3 1)
                1)))
        (ex3 (node-constructor
              'black
              t1
              y
              (node-constructor
               'red
               (node-constructor 'black t2 u t3 1)
               z
               (node-constructor 'black l v r 1)
               1)
              1))
        (ans3 (node-constructor
               'red
               (node-constructor 'black t1 y t2 1)
               u
               (balance
                (node-constructor
                 'black
...
(let ((t1 (node-constructor 'black #f 1 #f 1))
      ...
      (r #f)
      (v 9))
  (let ((ex1 (node-constructor 'black t1 y (node-constructor 'red t2 x t3 1) 1))
        (ans1 (node-constructor
               'red
               t1
               y
               (node-constructor 'black t2 x t3 1)
               1))
        (ex2 (node-constructor
              'black
              (node-constructor 'black t1 z t2 1)
              y
              t3
              1))
        (ans2 (balance
               (node-constructor
                'black
                (node-constructor 'red t1 z t2 1)
                y
                t3
                1)))
        (ex3 (node-constructor
...
(let ((t1 (node-constructor 'black #f 1 #f 1))
      ...
      (z 7))
  (let ((s (fuse t2 t3)))
    (let ((s1 (node->left s)) (s2 (node->right s)))
      (display-and-test
       (fuse t1 (node-constructor 'red t3 y t4 1))
       (node-constructor 'red (fuse t1 t3) y t4 1)
       "Case1")
      (display-and-test
       (fuse (node-constructor 'red t1 x t2 1) t3)
       (node-constructor 'red t1 x (fuse t2 t3) 1)
       "Case2")
      (fuse-helper
       (node-constructor 'red t1 x t2 1)
       (node-constructor 'red t3 y t4 1)
       (node-constructor
        'red
        (node-constructor 'red t1 x s1 1)
        z
        (node-constructor 'red s2 y t4 1)
        1)
       (node-constructor 'red t1 x (node-constructor 'red s y t4 1) 1)
       "Case3")
      (fuse-helper
       (node-constructor 'black t1 x t2 1)
       (node-constructor 'black t3 y t4 1)
       (node-constructor
        'red
        (node-constructor 'black t1 x s1 1)
        z
        (node-constructor 'black s2 y t4 1)
        1)
       (balL (node-constructor
              'black
              t1
              x
              (node-constructor 'black s y t4 1)
              1))
       "Case4")
